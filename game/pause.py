...
class MainInterface(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.image = pygame.image.load(os.path.join(Config.IMAGE_PATH, 'pause_backgrond.png'))
...
class ResumeButton(pygame.sprite.Sprite):
    def __init__(self, x = Config.SCREEN_WIDTH // 2, y = 400):
        pygame.sprite.Sprite.__init__(self)
        self.image_1 = pygame.image.load(os.path.join(Config.IMAGE_PATH, 'resume_button_1.png'))
        self.image_2 = pygame.image.load(os.path.join(Config.IMAGE_PATH, 'resume_button_2.png'))
...
class PauseInterface():
    ...
    def __init__(self):
        ...
        self.componets = pygame.sprite.LayeredUpdates(self.main_interface, self.resume_btn)
